        ...
        try {
            switch(request.type) {
                case OpCode.create:
                    ...
                    ChangeRecord var7 = getRecordForPath(parentPath);
                    checkACL(zks, var7.acl, ZooDefs.Perms.CREATE, request.authInfo);
                    int parentCVersion = var7.stat.getCversion();
                    ...
                    boolean ephemeralParent = var7.stat.getEphemeralOwner() != 0;
                    if (ephemeralParent) {
                    ...
                    var7 = var7.duplicate(txnHeader.getZxid());
                    var7.childCount++;
                    var7.stat.setCversion(var7.stat.getCversion() + 1);
                    addChangeRecord(var7);
                ...
                case OpCode.delete:
                    ...
                    var7 = getRecordForPath(parentPath);
                    ChangeRecord nodeRecord = getRecordForPath(path);
                    checkACL(zks, var7.acl, ZooDefs.Perms.DELETE, request.authInfo);
