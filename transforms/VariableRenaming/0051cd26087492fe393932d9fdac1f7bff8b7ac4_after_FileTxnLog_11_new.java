...
public class FileTxnLog implements TxnLog {
    ...
    public static class FileTxnIterator implements TxnLog.TxnIterator {
         ...
         * @throws IOException
         */
        protected InputArchive createInputArchive(File var0) throws IOException {
            if (inputStream == null) {
                inputStream = new PositionInputStream(new BufferedInputStream(new FileInputStream(var0)));
                LOG.debug("Created new input stream " + var0);
                ia = BinaryInputArchive.getArchive(inputStream);
                inStreamCreated(ia, inputStream);
                LOG.debug("Created new input archive " + var0);
            }
            return ia;
        }
