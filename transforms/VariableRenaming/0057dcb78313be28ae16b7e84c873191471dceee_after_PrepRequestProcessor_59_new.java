...
public class PrepRequestProcessor extends Thread implements RequestProcessor {
    ...
    protected void pRequest(Request request) {
        ...
        try {
            switch(request.type) {
                case OpCode.create:
                    ...
                    } catch (KeeperException.NoNodeException var24) {
                    }
        ...
        } catch (KeeperException var24) {
            if (txnHeader != null) {
                txnHeader.setType(OpCode.error);
                txn = new ErrorTxn(var24.code().intValue());
            }
            LOG.warn("Got exception when processing " + request.toString(), var24);
            request.setException(var24);
        } catch (Exception var24) {
            // error to the user
            LOG.error("Failed to process " + request, var24);
