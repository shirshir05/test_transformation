        ...
        try {
            switch(request.type) {
                case OpCode.create:
                    ...
                    StatPersisted var13 = new StatPersisted();
                    if (createMode.isEphemeral()) {
                        var13.setEphemeralOwner(request.sessionId);
                    }
                    ...
                    addChangeRecord(new ChangeRecord(txnHeader.getZxid(), path, var13, 0, createRequest.getAcl()));
                    break;
                case OpCode.delete:
