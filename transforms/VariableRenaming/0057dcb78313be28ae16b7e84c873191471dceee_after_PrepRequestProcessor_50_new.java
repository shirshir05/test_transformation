        ...
        try {
            switch(request.type) {
                ...
                case OpCode.delete:
                    ...
                    ChangeRecord var15 = getRecordForPath(path);
                    checkACL(zks, parentRecord.acl, ZooDefs.Perms.DELETE, request.authInfo);
                    int version = deleteRequest.getVersion();
                    if (version != -1 && var15.stat.getVersion() != version) {
                        throw new KeeperException.BadVersionException();
                    }
                    if (var15.childCount > 0) {
                ...
                case OpCode.setData:
                    ...
                    var15 = getRecordForPath(path);
                    checkACL(zks, var15.acl, ZooDefs.Perms.WRITE, request.authInfo);
                    version = setDataRequest.getVersion();
                    int currentVersion = var15.stat.getVersion();
                    if (version != -1 && version != currentVersion) {
                        throw new KeeperException.BadVersionException();
                    }
                    version = currentVersion + 1;
                    txn = new SetDataTxn(path, setDataRequest.getData(), version);
                    var15 = var15.duplicate(txnHeader.getZxid());
                    var15.stat.setVersion(version);
                    addChangeRecord(var15);
                    break;
                case OpCode.setACL:
                    ...
                    var15 = getRecordForPath(path);
                    checkACL(zks, var15.acl, ZooDefs.Perms.ADMIN, request.authInfo);
                    version = setAclRequest.getVersion();
                    currentVersion = var15.stat.getAversion();
                    if (version != -1 && version != currentVersion) {
                        throw new KeeperException.BadVersionException();
                    }
                    version = currentVersion + 1;
                    ...
                    var15 = var15.duplicate(txnHeader.getZxid());
                    var15.stat.setAversion(version);
                    addChangeRecord(var15);
                    break;
