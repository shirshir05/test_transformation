...
public class PrepRequestProcessor extends Thread implements RequestProcessor {
    ...
    protected void pRequest(Request request) {
        ...
        try {
            switch(request.type) {
                case OpCode.create:
                    var1 = new TxnHeader(request.sessionId, request.cxid, zks.getNextZxid(), zks.getTime(), OpCode.create);
                    ...
                    parentRecord = parentRecord.duplicate(var1.getZxid());
                    parentRecord.childCount++;
                    parentRecord.stat.setCversion(parentRecord.stat.getCversion() + 1);
                    addChangeRecord(parentRecord);
                    addChangeRecord(new ChangeRecord(var1.getZxid(), path, s, 0, createRequest.getAcl()));
                    break;
                case OpCode.delete:
                    var1 = new TxnHeader(request.sessionId, request.cxid, zks.getNextZxid(), zks.getTime(), OpCode.delete);
                    zks.sessionTracker.checkSession(request.sessionId, request.getOwner());
                    ...
                    parentRecord.stat.setCversion(parentRecord.stat.getCversion() + 1);
                    addChangeRecord(parentRecord);
                    addChangeRecord(new ChangeRecord(var1.getZxid(), path, null, -1, null));
                    break;
                case OpCode.setData:
                    var1 = new TxnHeader(request.sessionId, request.cxid, zks.getNextZxid(), zks.getTime(), OpCode.setData);
                    zks.sessionTracker.checkSession(request.sessionId, request.getOwner());
                    ...
                    nodeRecord = nodeRecord.duplicate(var1.getZxid());
                    nodeRecord.stat.setVersion(version);
                    addChangeRecord(nodeRecord);
                    break;
                case OpCode.setACL:
                    var1 = new TxnHeader(request.sessionId, request.cxid, zks.getNextZxid(), zks.getTime(), OpCode.setACL);
                    zks.sessionTracker.checkSession(request.sessionId, request.getOwner());
                ...
                case OpCode.createSession:
                    var1 = new TxnHeader(request.sessionId, request.cxid, zks.getNextZxid(), zks.getTime(), OpCode.createSession);
                ...
                case OpCode.closeSession:
                    var1 = new TxnHeader(request.sessionId, request.cxid, zks.getNextZxid(), zks.getTime(), OpCode.closeSession);
                    zks.sessionTracker.checkSession(request.sessionId, request.getOwner());
                    ...
                    synchronized (zks.outstandingChanges) {
                        ...
                        for (String path2Delete : es) {
                            addChangeRecord(new ChangeRecord(var1.getZxid(), path2Delete, null, 0, null));
                        }
                    }
