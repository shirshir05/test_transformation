        ...
        try {
            switch(request.type) {
                ...
                case OpCode.delete:
                    ...
                    int var16 = deleteRequest.getVersion();
                    if (var16 != -1 && nodeRecord.stat.getVersion() != var16) {
                ...
                case OpCode.setData:
                    ...
                    var16 = setDataRequest.getVersion();
                    int currentVersion = nodeRecord.stat.getVersion();
                    if (var16 != -1 && var16 != currentVersion) {
                        throw new KeeperException.BadVersionException();
                    }
                    var16 = currentVersion + 1;
                    txn = new SetDataTxn(path, setDataRequest.getData(), var16);
                    nodeRecord = nodeRecord.duplicate(txnHeader.getZxid());
                    nodeRecord.stat.setVersion(var16);
                ...
                case OpCode.setACL:
                    ...
                    var16 = setAclRequest.getVersion();
                    currentVersion = nodeRecord.stat.getAversion();
                    if (var16 != -1 && var16 != currentVersion) {
                        throw new KeeperException.BadVersionException();
                    }
                    var16 = currentVersion + 1;
                    txn = new SetACLTxn(path, setAclRequest.getAcl(), var16);
                    nodeRecord = nodeRecord.duplicate(txnHeader.getZxid());
                    nodeRecord.stat.setAversion(var16);
                    addChangeRecord(nodeRecord);
                    break;
