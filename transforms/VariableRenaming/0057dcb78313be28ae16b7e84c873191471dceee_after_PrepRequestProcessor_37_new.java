        ...
        try {
            switch(request.type) {
                case OpCode.create:
                    ...
                    var2 = new CreateTxn(path, createRequest.getData(), createRequest.getAcl(), createMode.isEphemeral());
                ...
                case OpCode.setData:
                    ...
                    var2 = new SetDataTxn(path, setDataRequest.getData(), version);
                ...
                case OpCode.setACL:
                    ...
                    version = currentVersion + 1;
                    var2 = new SetACLTxn(path, setAclRequest.getAcl(), version);
                    nodeRecord = nodeRecord.duplicate(txnHeader.getZxid());
            ...
            if (txnHeader != null) {
                ...
                var2 = new ErrorTxn(e.code().intValue());
            }
            ...
            if (txnHeader != null) {
                txnHeader.setType(OpCode.error);
                var2 = new ErrorTxn(Code.MARSHALLINGERROR.intValue());
            }
        }
