        ...
        try {
            switch(request.type) {
                case OpCode.create:
                    ...
                    CreateMode var9 = CreateMode.fromFlag(createRequest.getFlags());
                    if (var9.isSequential()) {
                    ...
                    txn = new CreateTxn(path, createRequest.getData(), createRequest.getAcl(), var9.isEphemeral());
