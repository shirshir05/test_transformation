        ...
        try {
            switch(request.type) {
                case OpCode.create:
                    ...
                    } catch (KeeperException.NoNodeException var11) {
                    }
            ...
            if (txnHeader != null) {
                ...
                txn = new ErrorTxn(var11.code().intValue());
            }
            LOG.warn("Got exception when processing " + request.toString(), var11);
            request.setException(var11);
        } catch (Exception var11) {
            // error to the user
            LOG.error("Failed to process " + request, var11);
