        ...
        try {
            switch(request.type) {
                case OpCode.create:
                    ...
                    String var6 = path.substring(0, lastSlash);
                    ChangeRecord parentRecord = getRecordForPath(var6);
                ...
                case OpCode.delete:
                    ...
                    var6 = path.substring(0, lastSlash);
                    parentRecord = getRecordForPath(var6);
