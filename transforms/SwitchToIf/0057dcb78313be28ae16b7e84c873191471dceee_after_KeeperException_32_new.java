...
public abstract class KeeperException extends Exception {
    ...
    static String getCodeMessage(Code code) {
        if (code == OK) {
            ...
            return "SystemError";
        } else if (code == RUNTIMEINCONSISTENCY) {
            return "RuntimeInconsistency";
        } else if (code == DATAINCONSISTENCY) {
            return "DataInconsistency";
        } else if (code == CONNECTIONLOSS) {
            return "ConnectionLoss";
        } else if (code == MARSHALLINGERROR) {
            return "MarshallingError";
        } else if (code == UNIMPLEMENTED) {
            return "Unimplemented";
        } else if (code == OPERATIONTIMEOUT) {
            return "OperationTimeout";
        } else if (code == BADARGUMENTS) {
            return "BadArguments";
            ...
            return "NoAuth";
        } else if (code == BADVERSION) {
            return "BadVersion";
        } else if (code == NOCHILDRENFOREPHEMERALS) {
            return "NoChildrenForEphemerals";
        } else if (code == NODEEXISTS) {
            return "NodeExists";
        } else if (code == INVALIDACL) {
            return "InvalidACL";
        } else if (code == AUTHFAILED) {
            return "AuthFailed";
        } else if (code == NOTEMPTY) {
            return "Directory not empty";
        } else if (code == SESSIONEXPIRED) {
            return "Session expired";
        } else if (code == INVALIDCALLBACK) {
            return "Invalid callback";
        } else if (code == SESSIONMOVED) {
